...
module DateTime : sig
  ...
  (** The offset in effect at a WALL-clock [seconds] (the wall seconds treated as a UTC instant to
      resolve the zone — the Bolt 3/4 DateTime decoding approximation). *)
  val offset_seconds_at_wall : tz:tz -> int64 -> int option
